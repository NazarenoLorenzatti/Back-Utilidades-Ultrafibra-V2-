...
public class SNMPDeviceController {
     ...
     * @return 
     */
    @PostMapping("/editar-dispositivo")
    ...
    public ResponseEntity<SNMPDeviceResponseRest> consultaSNMP(@RequestBody SNMPDevice dispositivo,@RequestBody OidClass oidSolicitud) {
        return deviceService.consultaSNMP(dispositivo, oidSolicitud);
    }
}
